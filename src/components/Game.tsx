...
const TitleScreen: React.FC<{ onStartGame: () => void; onSettings: () => void; onRules: () => void }> = ({ 
  ...
  <div className="flex flex-col items-center justify-center min-h-screen bg-gray-800 text-white">
    <h1 className="text-5xl font-bold mb-12">量子ゲート並べ</h1>
...
const RulesScreen: React.FC<{ onBack: () => void; onStartGame: () => void }> = ({ onBack, onStartGame }) => (
  <div className="flex flex-col min-h-screen bg-gray-800 text-white p-6">
    <div className="max-w-4xl mx-auto w-full">
      <h1 className="text-4xl font-bold mb-8 text-center">遊び方</h1>
      
      <div className="bg-gray-900 rounded-lg p-6 mb-6">
        <h2 className="text-2xl font-semibold mb-4 text-blue-400">ゲームの目的</h2>
      ...
      <div className="bg-gray-900 rounded-lg p-6 mb-6">
        <h2 className="text-2xl font-semibold mb-4 text-green-400">カードの種類</h2>
      ...
      <div className="bg-gray-900 rounded-lg p-6 mb-6">
        <h2 className="text-2xl font-semibold mb-4 text-yellow-400">基本ルール</h2>
      ...
      <div className="bg-gray-900 rounded-lg p-6 mb-6">
        <h2 className="text-2xl font-semibold mb-4 text-purple-400">配置ルール</h2>
