...
describe('GameScreen Advanced Coverage Tests', () => {
  ...
  describe('Settings and Storage', () => {
    it('should handle localStorage errors gracefully - line 82', () => {
    ...
    it('should handle storage change events - lines 96-98', async () => {
      renderWithI18n(<GameScreen onBackToMenu={mockOnBackToMenu} />);
  ...
  describe('Game State Checks', () => {
    it('should detect game in progress with cards on board - lines 120-125', async () => {
    ...
    it('should detect game in progress with different hand sizes - line 121', async () => {
    ...
    it('should detect game in progress with scores - line 122', async () => {
      const gameStateWithScores = createMockGameState({
        players: [
          { ...createMockGameState().players[0], score: 10 },
          { ...createMockGameState().players[1], score: 5 }
        ]
      });
    ...
    it('should detect game in progress with passes - line 123', async () => {
  ...
  describe('Hint System', () => {
    it('should update highlighted slots when hints disabled - lines 191-194', async () => {
  ...
  describe('Menu and Confirmation Popups', () => {
    it('should show confirmation popup when starting new game in progress', async () => {
    ...
    it('should handle cancel in confirmation popup', async () => {
      ...
      // Click back to title
      const backButton = screen.queryByText(/タイトルに戻る/) || screen.queryByTestId('back-to-menu-button');
      if (backButton) {
  ...
  describe('Animation and UI State', () => {
  ...
  describe('Initial Selection Phase', () => {
    it('should handle initial selection phase - line 117', async () => {
